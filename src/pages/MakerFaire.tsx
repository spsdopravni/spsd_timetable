  ...
  return (
    <>
      <div className="flex flex-col overflow-hidden h-screen relative" style={{ background: '#fafafa' }}>
          ...
          <div className="px-1 sm:px-4 lg:px-6 py-2 sm:py-4 lg:py-6 relative z-10 h-full flex items-center">
            <div className="grid grid-cols-1 lg:grid-cols-3 w-full gap-4 items-center">
              ...
              <div className="flex items-center gap-6 justify-start">
                <img
                  src="/pictures/makerfaire-logo.svg"
                  alt="Maker Faire Prague"
                  className="object-contain h-16 sm:h-20 lg:h-24"
                  onError={(e) => {
                    const t = e.target as HTMLImageElement;
                    t.outerHTML = '<span style="color:#F03553;font-weight:900;font-size:1.6rem;letter-spacing:0.05em">MAKER FAIRE</span>';
                  }}
                />
              ...
              <div className="text-center">
                ...
                <div className="mt-2 text-2xl" style={{ color: ACCENT }}>
                  ...
                  {metroInterval !== null && (
                    <span className="ml-2" style={{ color: ACCENT }}>interval ~{metroInterval} min</span>
                  )}
                </div>
              </div>
        ...
        {displayIndex === 0 && (
          ...
          <div className="flex flex-col lg:flex-row flex-1 overflow-hidden min-h-0">
            <div className="flex-1 p-2 overflow-hidden flex flex-col min-h-0">
              <div className={`${isTransitioning ? 'direction-header-animation fade-out' : 'direction-header-animation'} text-white px-3 shadow-lg flex items-center justify-center rounded-lg`} style={{ background: ACCENT, height: '6vh', minHeight: '70px', maxHeight: '90px' }} key={`left-${animKey}`}>
                <div className="flex items-center justify-center gap-3 w-full h-full">
                  <i className="fa-solid fa-location-dot text-white text-xl"></i>
                  <h2 className="font-black leading-none text-white" style={{ fontSize: 'clamp(1.75rem, 3.5vh, 2.5rem)' }}>Nástupiště A</h2>
                  {walkSecondsFor('vystavisteA') !== undefined && (
                    <span className="ml-2 inline-flex items-center gap-1 rounded-full bg-white/20 px-3 py-1 text-base font-bold">
            ...
            <div className="flex-1 p-2 overflow-hidden flex flex-col min-h-0">
              <div className={`${isTransitioning ? 'direction-header-animation fade-out' : 'direction-header-animation'} text-white px-3 shadow-lg flex items-center justify-center rounded-lg`} style={{ background: ACCENT, height: '6vh', minHeight: '70px', maxHeight: '90px' }} key={`right-${animKey}`}>
                <div className="flex items-center justify-center gap-3 w-full h-full">
                  <i className="fa-solid fa-location-dot text-white text-xl"></i>
                  <h2 className="font-black leading-none text-white" style={{ fontSize: 'clamp(1.75rem, 3.5vh, 2.5rem)' }}>Nástupiště B</h2>
        ...
        {displayIndex === 1 && (
          ...
          <div className="flex flex-col flex-1 overflow-hidden min-h-0 p-2">
            <div className={`${isTransitioning ? 'direction-header-animation fade-out' : 'direction-header-animation'} text-white px-3 shadow-lg flex items-center justify-center rounded-lg`} style={{ background: ACCENT, height: '6vh', minHeight: '70px', maxHeight: '90px' }} key={`vlak1-${animKey}`}>
              <div className="flex items-center justify-center gap-3 w-full h-full">
                <i className="fa-solid fa-train text-white text-xl"></i>
                <h2 className="font-black leading-none text-white" style={{ fontSize: 'clamp(1.75rem, 3.5vh, 2.5rem)' }}>Vlakové nádraží Praha-Výstaviště</h2>
        ...
        {displayIndex === 2 && (
          /* Praha-Bubny vlak */
          <div className="flex flex-col flex-1 overflow-hidden min-h-0 p-2">
            <div className={`${isTransitioning ? 'direction-header-animation fade-out' : 'direction-header-animation'} text-white px-3 shadow-lg flex items-center justify-center rounded-lg`} style={{ background: ACCENT, height: '6vh', minHeight: '70px', maxHeight: '90px' }} key={`vlak2-${animKey}`}>
              <div className="flex items-center justify-center gap-3 w-full h-full">
                <i className="fa-solid fa-train text-white text-xl"></i>
                <h2 className="font-black leading-none text-white" style={{ fontSize: 'clamp(1.75rem, 3.5vh, 2.5rem)' }}>Vlakové nádraží Praha-Bubny</h2>
        ...
        <div className="flex items-center justify-between px-6 py-2" style={{ background: '#1a1a1a' }}>
          <div className="flex items-center gap-3">
            <i className="fa-solid fa-robot text-xl" style={{ color: ACCENT }}></i>
            <span className="font-bold text-white text-sm">Maker Faire Prague</span>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-gray-400 text-sm">prague.makerfaire.com</span>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 w-full">
        <DailyRobot barColor="#1a1a1a" robotImage="/pictures/robot_makers_fair.png" customMessages={[
          "Vítejte na Maker Faire Prague!",
          "Maker Faire Prague · Výstaviště Praha · největší festival kreativity, vědy a technologií",
          ...
          "prague.makerfaire.com · Maker Faire Prague",
          "sps-dopravni.cz · Střední průmyslová škola dopravní",
          "Stavte si, programujte, tvořte — buďte makerem!",
          ...
          "Maker Faire Prague · prague.makerfaire.com",
        ]} />
      </div>
